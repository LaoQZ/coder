...
func TestFinalizeStaleChatDebugRows(t *testing.T) {
	...
	assert.WithinDuration(t, nowParam, updatedStaleRun.FinishedAt.Time, time.Millisecond,
		"finished_at should match the @now parameter")
	assert.WithinDuration(t, nowParam, updatedStaleRun.UpdatedAt, time.Millisecond,
	...
	assert.WithinDuration(t, nowParam, staleSteps[0].FinishedAt.Time, time.Millisecond,
		"step finished_at should match the @now parameter")
	assert.WithinDuration(t, nowParam, staleSteps[0].UpdatedAt, time.Millisecond,
	...
	assert.WithinDuration(t, nowParam, updatedCascadeRun.FinishedAt.Time, time.Millisecond,

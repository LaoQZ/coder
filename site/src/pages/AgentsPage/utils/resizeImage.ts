...
// probeNaturalDimensions reads an image's natural width/height via
// an <img> element without allocating a full ImageBitmap. Returns
// null on any decode/timeout failure; callers fall back to the
// legacy <img> decode path.
